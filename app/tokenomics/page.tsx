  ...
  return (
    <div className="w-full min-h-screen bg-black text-white flex flex-col items-center px-6 py-12 relative">
      ...
      <p className="text-center text-gray-400 max-w-xl mb-12">
        The chart below shows how WRAK was distributed — no fluff, no fake categories.
      </p>
      ...
      <div className="mt-10 max-w-xl text-sm text-gray-300 space-y-4 text-left">
        <p><strong>Torched on Sight (10%):</strong> 1B WRAK permanently burned on day one. No mintbacks.</p>
        <p><strong>Public Cheese (2%):</strong> 200M paired with 25 SOL on Raydium. Tradable. That’s it.</p>
        <p><strong>Vaulted Supply (88%):</strong> Held in the creator vault for future LP adds, rewards, and whatever comes next. No unlock schedule. No team vesting.</p>
      </div>
    </div>
  );
}
